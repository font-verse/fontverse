...
function Home() {
  ...
  return (
    <>
        ...
        <div className="home-left">
          <div className="home-left-container">
            <div className="home-heading">
              <h1>98,000+ Free Fonts</h1>
              <span>EXPERIENCE THE NEW WORLD OF FONTS</span>
            </div>
            <div className="home-search">
              <input type="text" placeholder="Search the font you want" />
      ...
      <TextScroll />
      <Catagories key={id} fontslist={fontsList} />
    </>
  );
}
