...
function FontBox({ fontFamily, fontWeight }) {
  const [favorite, setFavorite] = useState(false);

  return (
    <div className="font-box">
      <div className="font-box-heading">
        <span>{fontFamily}</span>
      </div>
      <div className="font-box-preview">
        <span style={{ fontFamily: fontFamily, fontWeight: fontWeight }}>
          Lorem ipsum, dolor sit amet consectetur adipisicing elit
        </span>
      </div>
      <div className="font-box-tools">
        <div className="font-box-styles">
          <div className="font-box-buttons">
            <button >
              <svg
        ...
        <div className="font-box-options">
          {/* favorite */}
          {favorite ? (
            <svg
              xmlns="http://www.w3.org/2000/svg"
